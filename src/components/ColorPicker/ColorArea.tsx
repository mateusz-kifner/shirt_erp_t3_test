...
function ColorArea(props: ColorAreaProps) {
  const { initialValue, isDisabled, hue = 0, onChange } = props;
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: active ? FOCUSED_THUMB_SIZE + 4 : THUMB_SIZE,
            width: active ? FOCUSED_THUMB_SIZE + 4 : THUMB_SIZE,
            left: areaState.saturation * 2,
            top: 200 - areaState.brightness * 2,
          }}
        ></div>
      </div>
      <span>{thumbColor.toHexString()}</span>
    </>
  );
}
