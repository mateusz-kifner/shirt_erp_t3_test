...
function Switch() {
  return (
    <RadixSwitch.Root className="relative h-[25px] w-[42px] cursor-default rounded-full bg-stone-800 shadow-[0_2px_10px] shadow-stone-950 outline-none focus:shadow-[0_0_0_2px] focus:shadow-black data-[state=checked]:bg-black">
